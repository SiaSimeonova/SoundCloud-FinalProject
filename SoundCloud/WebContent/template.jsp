		...
		<div class="row">
			<div class="col-md-3">
				...
				<img alt="Bootstrap Image Preview"
					src="./imageServlet/<%=request.getAttribute("picId")%>"
				...
				<div class="btn-group btn-group-lg btn-group-vertical">
					<audio id="audio_play<%=request.getAttribute("picId")%>">
						<source src="./audioServlet/<%=request.getAttribute("picId")%>"
							type="audio/mpeg" />

					</audio>
					<button
						onClick="document.getElementById('audio_play<%=request.getAttribute("picId")%>').play(); return false;"
						type="button" class="btn btn-circle btn-success">

						<span class="glyphicon glyphicon-play"></span>

					</button>
					<button
						onClick="document.getElementById('audio_play<%=request.getAttribute("picId")%>').pause(); return false;"
