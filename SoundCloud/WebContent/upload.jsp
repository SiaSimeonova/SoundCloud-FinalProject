...
<form class="login" action="./Upload" method="post" enctype="multipart/form-data">
	<span class="btn btn-danger btn-file btn-block">
    Choose File <input type="file" name="file">
	</span>
	<span class="btn btn-danger btn-file btn-block">
    Choose Picture <input type="file" name="pic">
	</span>
	 <div class="fields">
	<input type="text" name="trackName"  placeholder="Track name" required="required" />
	<input type="text" name="artistName"  placeholder="Artist name" required="required" />
	<input type="text" name="category"  placeholder="Ganre"  />
